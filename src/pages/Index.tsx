...
const T = {
  ru: {
    ...
    extra: "Цена фиксируется на дату подписания договора. Возможна поставка DDP, CIF, FOB по согласованию. Минимальная партия — 2000 тонн.",
    ...
    address: "г. Москва, ул. Каспийская, д. 22 к. 1 стр. 5, помещ. 22/6",
    inn: "9724242160",
    ogrn: "1267700177029",
  },
  en: {
    ...
    extra: "Price is fixed at contract signing date. DDP, CIF, FOB delivery available by agreement. Minimum order — 2,000 metric tons.",
    directorTitle: "General Director",
    directorName: "Erik Pogosyan",
    phone: "+7 933 000-07-02",
    email: "REAL.GROUP2020@MAIL.RU",
    website: "realgroup.pw",
    address: "Moscow, Kaspiyskaya st. 22/1/5, office 22/6",
    inn: "TIN: 9724242160",
  ...
  hi: {
    ...
    extra: "अनुबंध हस्ताक्षर की तारीख पर मूल्य निश्चित होता है। DDP, CIF, FOB डिलीवरी उपलब्ध। न्यूनतम ऑर्डर — 2,000 मीट्रिक टन।",
    directorTitle: "महानिदेशक",
    directorName: "Erik Pogosyan",
    phone: "+7 933 000-07-02",
    email: "REAL.GROUP2020@MAIL.RU",
    website: "realgroup.pw",
    address: "मॉस्को, कास्पियस्काया स्ट्रीट 22/1/5, कार्यालय 22/6",
    inn: "TIN: 9724242160",
    ogrn: "OGRN: 1267700177029",
  },
};
